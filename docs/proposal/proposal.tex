...
There are a number of existing podcast streaming services on the market. The key functionalities of Spotify\cite{spotify}, Sticher\cite{sticher} and Player FM\cite{player_fm} will be discussed in the following sections.
A summary of the comparison is shown in table \ref{table:comparison_features}.
